package com.ryderbelserion.fusion.paper.builders.gui.interfaces.types;
...
public interface IBaseGui {
    ...
    @NotNull Component title(@NotNull final Audience audience, @NotNull final Map<String, String> placeholders);
