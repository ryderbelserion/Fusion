package com.ryderbelserion.fusion.paper.builders.folia;
...
public abstract class FoliaScheduler implements Runnable {
    ...
    private void isScheduled() throws FusionException {
        if (this.task != null) throw new FusionException("The task is already scheduled as %s".formatted(this.task.hashCode()));
    }
}