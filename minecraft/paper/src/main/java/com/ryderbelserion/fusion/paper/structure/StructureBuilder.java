...
public class StructureBuilder {
    ...
    public StructureBuilder(@NotNull final JavaPlugin plugin, @NotNull final PaperFileManager fileManager, @NotNull final NamespacedKey key) {
        this.manager = plugin.getServer().getStructureManager();
    ...
    public StructureBuilder(@NotNull final JavaPlugin plugin, @NotNull final PaperFileManager fileManager, @NotNull final String keyName) {
        this.manager = plugin.getServer().getStructureManager();
