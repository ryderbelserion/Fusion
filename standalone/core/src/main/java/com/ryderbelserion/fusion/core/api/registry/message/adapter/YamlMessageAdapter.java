...
public class YamlMessageAdapter extends IMessageAdapter<CommentedConfigurationNode> {
    ...
    public YamlMessageAdapter(final CommentedConfigurationNode configuration, final String defaultValue, final Map<String, String> placeholders, final Object... path) {
    ...
    public YamlMessageAdapter(final CommentedConfigurationNode configuration, final String defaultValue, final Object... path) {
