...
public class YamlMessageAdapter extends IMessageAdapter<CommentedConfigurationNode> {
    ...
    public YamlMessageAdapter(@NonNull final CommentedConfigurationNode configuration, @NonNull final String defaultValue, @NonNull final Map<String, String> placeholders, @NonNull final Object... path) {
    ...
    public YamlMessageAdapter(@NonNull final CommentedConfigurationNode configuration, @NonNull final String defaultValue, @NonNull final Object... path) {
