...
public class SimpleExtensionClassLoader extends URLClassLoader {
    ...
    public SimpleExtensionClassLoader(@NonNull final Path path, @NonNull final Path source,
                                      @NonNull final IExtensionMeta extension, @NonNull final ClassLoader loader) throws IOException, InvalidExtensionException {
